...
*-F, --file* <file>::
    Write attachment data to a specified file.
+
...
.Output attachment data to standard output:
 bite bugzilla attachment get 123 -F -

*-o, --obsolete*::
    Include obsolete attachments.
+
This forces obsolete attachments to be shown instead of being skipped by
default.
...
+
By default, existing files won't be overwritten.
